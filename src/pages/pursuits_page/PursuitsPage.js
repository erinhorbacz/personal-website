          ...
          <div className="content_box">
            ...
            >
              <p style={{ width: "600px", textAlign: "justify" }}>
                {" "}
                Among many things, I have a passion for Software Engineering. I
                enjoy the process of creating elegant programs from code and
                ...
                <br />
                Although I've spent a lot of time in the lab, what I really love
                is industry work. I've loved my previous experience working in
                industry, and I see myself working as a Software Engineer in
                Tech for the forseable future.
              </p>
            </div>
          </div>
          <div ref={bottomRef} />
          ...
          <div className="content_box">
            ...
            >
              <p style={{ width: "600px", textAlign: "justify" }}>
                ...
                site, but I'd love to take some real art lessons and improve my
                skills. I plan on investing in myself (once I have the means to
                do so) by taking some painting lessons. As of now, I rely on the
                free ones that Bob Ross provides. <br />
                <br />
                ...
                museaums to dog walking clubs. My favorite city is New York, and
                it's been my dream since I was a kid to be a New Yorker. I'm
                looking forward to calling it home... although I am not looking
                forward to the rent.
              </p>
            </div>
          </div>
